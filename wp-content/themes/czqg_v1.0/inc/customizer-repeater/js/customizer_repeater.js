...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '#customize-control-CLOUDPRESS_team_content .customizer-repeater-new-field', function () {
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-' + customizer_repeater_uniqid();
        if (typeof th !== 'undefined') {
            /* Clone the first box*/
...
theme_conrols.on('click', '#customize-control-CLOUDPRESS_funfact_content .customizer-repeater-new-field', function () {
    ...
    theme_conrols.on('click', '#customize-control-CLOUDPRESS_team_content .social-repeater-general-control-remove-field', function () {
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                jQuery(this).parent().remove();
                customizer_repeater_refresh_general_control_values();
