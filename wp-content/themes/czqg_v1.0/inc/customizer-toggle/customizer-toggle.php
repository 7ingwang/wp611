<?php
function CLOUDPRESS_toggle_customizer($wp_customize) {
class CLOUDPRESS_Toggle_Control extends WP_Customize_Control {
	public $type = 'ios';
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'pure-css-toggle-buttons', $this->abs_path_to_url( dirname( __FILE__ ) . '/css/toggle.css' ), array(), rand() );
...
add_action('customize_register','CLOUDPRESS_toggle_customizer');
